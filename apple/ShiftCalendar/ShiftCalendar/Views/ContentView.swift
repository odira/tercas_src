...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            List {
                ShiftRow(title: "Night Shift", shift: nightShift)
                ShiftRow(title: "Morning Shift", shift: morningShift)
                ShiftRow(title: "Afternoon Shift", shift: afternoonShift)
                ShiftRow(title: "Evening Shift", shift: eveningShift)
            }
