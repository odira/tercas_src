...
{
    m_model = static_cast<QSqlTableModel *>(new ActivityModel);
...
//    m_view->setItemDelegate(new TableViewDelegate);
    m_view->setColumnHidden(ActivityModel::Columns::pid, true);
    m_view->setColumnHidden(ActivityModel::Columns::abbr, true);
