 ...
 */
    ...
    if (col == EmplActivityModel::Columns::activity_pid) {
        ...
        QModelIndex colorIdx = model->index(row, EmplActivityModel::Columns::activity_color);
        QModelIndex abbrIdx = model->index(row, EmplActivityModel::Columns::activity_abbr);
