...
//    m_view->setItemDelegate(new TableViewDelegate);
    m_view->setColumnHidden(EmplActivityModel::Columns::activity_pid, true);
    m_view->setColumnHidden(EmplActivityModel::Columns::activity_abbr, true);
    m_view->setColumnHidden(EmplActivityModel::Columns::activity_path, true);
