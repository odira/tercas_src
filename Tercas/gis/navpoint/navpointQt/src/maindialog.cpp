...
void MainDialog::setupView()
{
    ...
    m_view->setColumnHidden(GisNavPointModel::Columns::navpoint_pid, true);
    m_view->setColumnHidden(GisNavPointModel::Columns::navpoint_nodepid, true);
    m_view->selectRow(0);
}
