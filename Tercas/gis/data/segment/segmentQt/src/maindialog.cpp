...
void MainDialog::setupView()
{
    ...
    m_view->setColumnHidden(LineSegmentModel::Columns::linesegment_pid, true);
    m_view->setColumnHidden(LineSegmentModel::Columns::linesegment_geog, true);
    m_view->selectRow(0);
}
