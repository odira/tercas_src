...
void MainDialog::setupView()
{
    ...
    m_view->setColumnHidden(GisRlpModel::Columns::rlp_pid, true);
    m_view->setColumnHidden(GisRlpModel::Columns::rlp_nodepid, true);
    m_view->setColumnHidden(GisRlpModel::Columns::rlp_nodegeog, true);
    m_view->setColumnHidden(GisRlpModel::Columns::rlp_nodenoteru, true);
    m_view->selectRow(0);
}
