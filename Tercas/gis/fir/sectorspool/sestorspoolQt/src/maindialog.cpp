...
{
    m_model = new GisSectorsPoolModel;
...
void MainDialog::setupView()
{
    ...
    m_view->setColumnHidden(GisSectorsPoolModel::Columns::sectorspool_pid, true);
    m_view->setColumnHidden(GisSectorsPoolModel::Columns::sectorspool_sectorpidarr, true);
    m_view->setColumnHidden(GisSectorsPoolModel::Columns::sectorspool_color, true);
    m_view->selectRow(0);
}
